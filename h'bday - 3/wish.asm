...
local ps:PAINTSTRUCT
	...
	.if uMsg == WM_INITDIALOG
		...
		mov hBrush,eax
		invoke ImageButton,hWnd,462,233,703,701,702,ExitBtn		
		mov hExit,eax
		...
		mov scr.scroll_text,chr$(".:: ~ greetings from stark 9000 ::.  : ¸¸.•*¨*• ¦H¦A¦P¦P¦Y¦ -- ¦B¦I¦R¦T¦H¦D¦A¦Y¦ •.¸¸.•*´¨! --| Life is a journey.-->> Enjoy every mile. ! [ from Saliya Ruchiranga to Shehan Weerasekera.")
		mov scr.scroll_x,120
		mov scr.scroll_y,30
		...
		mov scr.scroll_textcolor,00EA9F44h
