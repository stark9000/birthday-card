...
local ps:PAINTSTRUCT
	...
	.if uMsg == WM_INITDIALOG
		...
		mov hBrush,eax
		invoke ImageButton,hWnd,510,265,703,701,702,ExitBtn		
		mov hExit,eax
		...
		mov scr.scroll_text,chr$(".:: ~ greetings from stark 9000 ::.  : ¸¸.•*¨*• [H][a][p][p][y][B][i][r][t][h][d][a][y] ! •*¨*•.¸¸  | Wishing you lots of peace,happiness, luck, prosperity & good fortune in life ![ from Saliya Ruchiranga to ( brother in law )Damitha Chathuranga (DC)]")
		mov scr.scroll_x,70
		mov scr.scroll_y,30
		...
		mov scr.scroll_textcolor,00000040h
